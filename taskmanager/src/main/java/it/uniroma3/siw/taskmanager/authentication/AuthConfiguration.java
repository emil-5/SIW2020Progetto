...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/users/register", "/users/registerAdmin").permitAll()
                .antMatchers(HttpMethod.POST, "/login", "/users/register", "/users/registerAdmin").permitAll()
